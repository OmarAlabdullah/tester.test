...
class db
{
	...
	function select($params)
	{
		...
		$clean_results = $this->selectFromData($this->table, $select_colums, $conditions, null, $limit);
	...
	private function selectFromData($table, $fields = array(), $conditions = array(), $order, $limit)
	{
