...
/////////////// die heb ik toegevoegd voor additional_data //////////////////////////
			...
			foreach($required_additional_data as $index => $d)
				if(empty($d))
					unset($required_additional_data[$index]);

			$project_list['Project_list']['required_additional_data_array'] = $required_additional_data;
/////////////////////////////////////////////////////////////////////////////////////////
			...
			{
				/////////////// die heb ik toegevoegd voor additional_data //////////////////////////
				$required_additional_data = $controller['post']['required_additional_data'];
				echo $required_additional_data;
				foreach($required_additional_data as $d)
				{
					$d = trim($d);
					if(!empty($d))
					{
						$required_additional_data_string .= $d . '|';
					}
				}
				$required_additional_data_string = substr($required_additional_data_string, 0, -1);
				$project_list['Project_list']['required_additional_data'] = $required_additional_data_string;
